...
# -----------
to scan repo for secrets leaks use
...
## setup
- config dir is to validate envs are not missing
- MongoDB and mongo-express setted up
to run mongo and ui locally, otherwise use mongoatlas cloud
  ````
  docker compose up -d
  ````
- prisma setup
